        ...
        <div className="space-y-8">
          <Card className="bg-slate-800/50 border-purple-500/20">
            ...
            <CardContent className="space-y-6">
              ...
              <div className="flex items-center space-x-4">
                <a 
                  href="https://www.instagram.com/mission_cosmos/?next=%2F"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="transition-colors duration-200 hover:text-pink-300"
                >
                  <svg className="h-6 w-6 text-pink-400 hover:text-pink-300 transition-colors duration-200 cursor-pointer" fill="currentColor" viewBox="0 0 24 24">
